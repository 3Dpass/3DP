...
use sp_runtime::{traits::Zero, FixedPointNumber, FixedU128, SaturatedConversion};

use poscan_api::ConversionFromAssetBalance;
	...
	T: Config,
{
	...
	fn from_asset_balance(
		...
		let bal: u128 = balance.saturated_into();
		Ok(rate.saturating_mul_int(bal).saturated_into())
	}
}
